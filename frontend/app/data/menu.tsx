...
export const MenuData:Array<MenuItem> = [
    {
        ...
        subMenu: [
            ...
            { 
                ...
                type: 'document', active: false,
                roles: 
                [UserRoles.HEADCOMPANY, UserRoles.ADMIN, UserRoles.GUEST, UserRoles.HEADSECTION, UserRoles.DELIVERY, UserRoles.GLBUX]
            },
            { 
            ...
            { 
                ...
                type: 'document', active: false,
                roles: 
                [UserRoles.HEADCOMPANY, UserRoles.ADMIN, UserRoles.GUEST, UserRoles.HEADSECTION, UserRoles.GLBUX]
            },
    ...
    },
    {
        ...
        subMenu: [
            ...
            { 
                ...
                type: 'report', active: false,
                roles: 
                [UserRoles.HEADCOMPANY, UserRoles.ADMIN, UserRoles.GLBUX, UserRoles.GUEST, UserRoles.HEADSECTION, UserRoles.DELIVERY]
            },
            { 
