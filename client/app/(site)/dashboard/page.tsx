'use client'
import { Htag } from '@/client/app/components'
import { MenuData } from '@/client/app/data/menu'
import Menu from '@/client/app/components/menu/menu'
...
import Report from '@/client/app/components/report/report'
import { ContentType, DashboardSettings } from '@/client/app/interfaces/general.interface'
import { useEffect, useState } from 'react'
import Image from 'next/image'
import ReportWindow from '@/client/app/components/reportWindow/reportWindow'
import { getReportTypeByTitle } from '@/client/app/utils/getReportTypeByTitle'
