...
import { Button, Htag, Info, Input, Select, DocTable } from '@/client/app/components';
import TrashIco from './ico/trash.svg';
import AddIco from './ico/add.svg'
import { DocumentTableItem, DocumentType, OptionDocumentElements } from '@/client/app/interfaces/documents/mainDocument.interface';
import { ReferenceType } from '@/client/app/interfaces/references/mainReference.interface';
import { getOptionOfDocumentElements } from '@/client/app/utils/getOptionOfDocumentElements';
